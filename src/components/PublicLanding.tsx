          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {tournaments.map((tournament) => (
                <div
                  key={tournament.id}
                  className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-white/10 hover:border-white/20 transition-all"
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Sign up and link your Activision ID to start competing.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Browse and join tournaments with entry fees and real prizes.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Play matches, get automatically scored, and win prizes.
              </p>
            </div>
          </div>
        </div>
